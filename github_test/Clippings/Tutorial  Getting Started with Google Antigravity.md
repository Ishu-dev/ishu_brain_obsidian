...
source: "https://medium.com/google-cloud/tutorial-getting-started-with-google-antigravity-b5cc74c103c2"
author:
  - "[[Romin Irani]]"
published: 2025-11-19
created: 2026-04-11
description: "Welcome to the tutorial on Antigravity, Google's free and experimental Agent first development platform."
tags:
  - "clippings"
---
## [Google Cloud - Community](https://medium.com/google-cloud?source=post_page---publication_nav-e52cf94d98af-b5cc74c103c2---------------------------------------)

[![Google Cloud - Community](https://miro.medium.com/v2/resize:fill:76:76/1*FUjLiCANvATKeaJEeg20Rw.png)](https://medium.com/google-cloud?source=post_page---post_publication_sidebar-e52cf94d98af-b5cc74c103c2---------------------------------------)
...
There is a [codelab version of this tutorial](https://codelabs.developers.google.com/getting-started-google-antigravity?hl=en#0) too. If you’d like to follow step by step, check it out. It is now available as a 2-part codelab:
...
> 
> ***December 18, 2025:  
> ****\- Added MCP Servers support in Antigravity*
> 
> ***November 28, 2025:****  
> \- How to navigate this tutorial.  
> \- Workflows and Rules in Antigravity  
> \- Agent Security — Allow List, Deny List and Browser Allow Lists.*
> 
> ***November 20, 2025:*** *Initial version*

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*3j-fYLegUxVi1YjvdsnS2A.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*OJmBOypaRbPGDqaH7Sw4lQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*f7QILyn_nJsZDirbZpma9Q.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*SIkY4VS7rwf72hZhNjvidQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*14NZ5WyyBl61hpQ9ahRR_g.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*JQw2-fXpIBRJhoj_Uw2LmA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*GY_yiBuoylnTnav8f9n1Aw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*7lVeH0K0pkoBIhETIfm16g.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*DdC4iSAlsDmdGUWS3LXRGA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*UTIAaWZBHkj5ANBRvB6Pzw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*1EBb2ySUTv9OtTic_zWjxA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*p62eR0LEvf9RgWkiEX0ESg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*M9OPnjeRPsZgQYZAYpYyFg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*rgvvZ_Ml031UdaBb66x5xQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*boe6TgMe4Kt0Ma0Sp7dmDw.png)

Similarly, we find that the Agent is going to be in a default `Planning` mode. But we can also go for the `Fast` mode.

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*6LRCj6Ynk1X_dhR2GgR8Zw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*w-n7i5YYybpqGghUjvpQ-w.png)
...
```
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*pFnQyXK-Uj8E-BIsly3oJQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Z8IyxMPZCggtIdtdApRMhA.png)

This will bring up the browser and display a message to install the extension as shown below:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*9UKzn--uKrDM3EGSrbkpQg.png)

Go ahead and you will be led to the Chrome Extension that you can then install.

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*RMW2yU1SosQmI4-8edyWAg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*LPMnGHMRiee0oSjNZFEE9Q.png)

Switch back to the Agent Manager and you should see the following:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*l7vbn-dd3K1A7pgDv1ARQg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*j-Kh2BfD-yMf4vP7I2-_Mg.png)
...
![](https://miro.medium.com/v2/resize:fit:1244/format:webp/1*AyrpOrmttyAh6FYCU2rASQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*uYXVOrvZsXzi9q8w21BwPg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*uHZj6YVsdSrAGWRBC5jwCQ.png)

Clicking on that conversation will provide you the details:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*WndqWGVvAP_YBsrnUyhzqw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*ySt5YkBVfBf2MNF5ZKKpLg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*astD1x0UHX1pHCFvgLr33A.png)

Then give the following instruction:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*pY9A0xUwr9xCbmQftItoRg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*SXN5i--9pgX3BIDybniRCg.png)

Once it's done with its work, you should also see the Artifacts getting generated, as shown below:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*rnwD9U_9CUuZbLHFZOlqxw.png)

A sample execution by the Agent is shown below:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*nC84hi046Iqbg78kflPYAQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*qUU4yZvGY6ectHeM0dO9YA.png)

You can then click on the **Implementation Plan** artifact. A sample screenshot is shown below:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Vbst0Ucg4MPhbUDUiThA-Q.png)

And finally, you have the **Walkthrough** artifact. It contains all that the Agent did as shown below:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*L-BPJ6Km-Nac1WulZ9f6yw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*qvpPvsA_ZwFcIsD9F-F5uw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Dp3ol3bGNIoU05Z8zW7jWw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*KnaacWqVe6jyKMKOY23qug.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*sYkq6a92YBt0JiSJV0BbMw.png)
...
![](https://miro.medium.com/v2/resize:fit:1180/format:webp/1*D3iqJUyGpVFwX8SjO3_s8w.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*PkbcKDNFbER6hINW1BRHTQ.png)

It then generated an image as it went through its task:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Sj7C_WhFTlUwyUBU5J5-bA.png)

Finally, the app had the image as we requested:

![](https://miro.medium.com/v2/resize:fit:1372/format:webp/1*GTiXdHvoq2qxyLQGkpZjeQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Y2NavpVyEmUuh-w9sYTReg.png)

This comes up with some explanation of what this file is:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*TDfT_qd0Z23b6qruoBC6fA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*LLVexnl39K4dvvGATKZDQQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*azlhBPxvvepUSizG09w8tw.png)

You can also see the details of the tests that it ran:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*g3pY_V1Ec4byDYianenvZg.png)

One of the files that it generated was the test file too. A screenshot of which is shown below:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*5g5Si_5tBHsjoA_GlShK9A.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*MkBkErYTx7a4x4WU1phySw.png)

This will bring up the **MCP Store** and you will see a large list of already supported servers, as shown below:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*QRHLbadURseiLZUJgyoGJQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*8Dzj5-ZuIfoLdV7AE0F3kA.png)
...
![](https://miro.medium.com/v2/resize:fit:1120/format:webp/1*z_Q8nMOox6vA9f8Ic75T1Q.png)

![](https://miro.medium.com/v2/format:webp/1*xoAITmuKIldv9iRZ8sk-9Q.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Gfm0qmstyB502Jbc81d1iQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Vql8Car2v6Hh-dbZGsagvQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*2Ws55O83SV-46P20Ur-8-g.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*asuLYD8ZgqNEx_Jkin8pEg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*7sy3PexiW97g6IiaRvwr0w.png)

## Governing Antigravity — Rules and Workflows

Developers require their tools to behave consistently. In a standard LLM chat interface, users often find themselves repeating the same context: “I use Python 3.9,” “Use snake\_case,” “Don’t use this library.”
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*lkIhivx1NV_6BuRZhM67Vw.png)

Click on that and then `Customizations → Manage`. You will see the following Rules and Workflows settings, as shown below:

![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*L0qtw61euIhWGaodzk4COw.png)
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*M9yDOp8zriQsS3PZPmAd0g.png)
...
- *Use Case:* Setting preferences for specific languages (e.g., “Always use TypeScript over JavaScript”), documentation standards (“Always add docstrings”), or ethical guidelines (“Never generate hardcoded API keys”).
...
2. **Result***:* The agent generates code with full type hints (e.g., `def fib(n: int) -> int:`) and docstrings.
...
**Rule 6: The Type Safety Decree** *Use this to force strict typing in dynamic languages.*
...
## [Tutorial: Getting Started with Antigravity Skills](https://medium.com/google-cloud/tutorial-getting-started-with-antigravity-skills-864041811e0d?source=post_page-----b5cc74c103c2---------------------------------------)

### This tutorial assumes that you are familiar with Google Antigravity, an agentic platform that evolves the IDE into an…
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*gn1g0ThD_gtK3hJT.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*2YyNHGVNAog-Udi2OK81Lg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*ayWhTXsiTHAu80fAoIuvOA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*PkzxIA7M4_Octutp354d_Q.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*6wNN0QRapY2pkhpvm0nJig.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*I3tRdM66e1LgMfS2FT2mBg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*CFOPxEs3nLxg7yzp1xG13A.png)
